...
src_path = "src/preprocessing/"
all_train_urls = src_path + "url_lists/all_train.txt"
all_val_urls = src_path + "url_lists/all_val.txt"
all_test_urls = src_path + "url_lists/all_test.txt"

finished_files_dir = "data/cnn-dm-summarizer"
...
def write_to_bin(url_file, out_prefix):
  ...
  with open(out_prefix + '.source.txt', 'wt') as source_file, open(out_prefix + '.target.txt', 'wt') as target_file:
...
if __name__ == '__main__':
  ...
  write_to_bin(all_val_urls, os.path.join(finished_files_dir, "valid"))
